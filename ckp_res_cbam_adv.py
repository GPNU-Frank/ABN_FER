...
from models.resnet_cbam_adv import resnet18_cbam
...
parser.add_argument('--dataset-path', default='data\ck+_6_classes_img_and_55_landmark_106_224.pickle')  # windows style
...
parser.add_argument('--schedule', type=int, nargs='+', default=[30, 50],
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/ckp_resnet_cbam_adv', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet_cbam_adv')
...
def main():
    ...
    model = resnet18_cbam(pretrained=False, num_classes=6)
