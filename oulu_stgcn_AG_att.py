...
parser.add_argument('--dataset-path', default='data/oulu_6_classes_img_and_55_landmark_3frames_A+G.pickle')  # windows style
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/oulu_stgcn_ag_att', type=str, metavar='PATH',
...
def main():
    ...
    model = ModelAGATT(2, 36, 6, {}, False, dropout=args.dropout)
