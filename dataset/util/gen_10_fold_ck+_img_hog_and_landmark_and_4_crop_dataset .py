...
def face_align_and_landmark(img_path):
    ...
    return hog_image, np.stack(list_landmarks, axis=1), left_eye_crop, right_eye_crop, nose_crop, lip_crop
...
if __name__ == '__main__':
    ...
    save_path = '../../data/ck+_6_classes_img_hog_and_55_landmark_4_crop.pickle'
