...
from models import RensnetAndSTGCN
import numpy as np
...
parser = argparse.ArgumentParser(description='PyTorch oulu Training')
# Datasets
parser.add_argument('-d', '--dataset', default='oulu', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/oulu_resnet_and_stgcn', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet_and_stgcn')
...
# Validate dataset
assert args.dataset == 'oulu', 'Dataset can only be oulu.'
...
def main():
    ...
    model = RensnetAndSTGCN(num_classes=num_classes)
