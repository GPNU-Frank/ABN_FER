...
from models import ResNetAndGCN, Model, ModelAtt
import numpy as np
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/ckp_stgcn_att', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='stgcn_att')
